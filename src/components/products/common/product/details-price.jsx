...
class DetailsWithPrice extends Component {
		...
		return options.map((vari, i) => {
			return (
				<li
					...
					// 			? `#ff4c3b`
					// 			: null,
					//   color:this.state.variationsSelected &&
					//   this.state.variationsSelected[index] &&
					//   this.state.variationsSelected[index].option_name ===
					//     vari.option_name
					//     ? `white`
					...
					// }}
				>
					<Link onClick={(e) => this.onSelectedOptions(index, vari)}>
						{vari.option_name}
					</Link>
				</li>
			);
	...
	render() {
		...
		return (
			<div className="col-lg-6 rtl-text product-details-right">
						...
						<>
							<h4>
								...
								<span>
									{(
										100 -
										(this.state.price / this.state.regularPrice) * 100
									).toFixed(0)}
									% off
								</span>
							</h4>
         	...
         	{item.inStock == "In Stock" ? (
							<h5 className="instock-cls text-success">{item.inStock}</h5>
						) : (
							<h5 className="instock-cls ">{item.inStock}</h5>
						)}
								...
								return (
									<>
										...
										attribute.attribute_name.toLowerCase() === "colour" ? (
											...
											<>
												<h4>Select {attribute.attribute_name}</h4>
					...
					<div className="product-description border-product">
						<h4 className="product-title">quantity</h4>
						<div className="row">
							...
							<div
								className="col-xl-9 col-lg-8 col-md-12 col-12"
