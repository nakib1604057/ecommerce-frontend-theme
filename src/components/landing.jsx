	...
	componentDidMount() {
		...
		sky.addEventListener("mousemove", function(e) {
			...
			elemThree.style.transform =
				...
				(1 + pageY / 150) +
				"%)";
			elemFour.style.transform =
				"translateX(" +
				(7 + pageX / 150) +
				"%) translateY(" +
				(1 + pageY / 150) +
				"%)";
			elemFive.style.transform =
				"translateX(" +
				(7 + pageX / 150) +
				"%) translateY(" +
				(1 + pageY / 150) +
				"%)";
			elemSix.style.transform =
				"translateX(" +
				(7 + pageX / 150) +
				"%) translateY(" +
				(1 + pageY / 150) +
				"%)";
			elemSeven.style.transform =
				"translateX(" +
				(7 + pageX / 150) +
				"%) translateY(" +
				(1 + pageY / 150) +
				"%)";
			elemEight.style.transform =
				"translateX(" +
				(7 + pageX / 150) +
				"%) translateY(" +
				(1 + pageY / 150) +
				"%)";
			elemNine.style.transform =
				"translateX(" +
				(7 + pageX / 150) +
				"%) translateY(" +
				(1 + pageY / 150) +
				"%)";
			elemTen.style.transform =
				"translateX(" +
				(7 + pageX / 150) +
				"%) translateY(" +
				(1 + pageY / 150) +
				"%)";
			elemEleven.style.transform =
				"translateX(" +
				(7 + pageX / 150) +
				"%) translateY(" +
				(1 + pageY / 150) +
	...
	render() {
		return (
			<div className="landing-page-Bay Of Style">
											...
											>
												<ul className="navbar-nav mx-auto nav">
													<li className="nav-item">
														<AnchorLink className="nav-link" href="#img-bg">
															Home
														</AnchorLink>
													</li>
													<li className="nav-item">
														<AnchorLink className="nav-link" href="#feature">
															Features
														</AnchorLink>
													</li>
													<li className="nav-item">
														<AnchorLink className="nav-link" href="#demo">
															Demo
														</AnchorLink>
													</li>
													<li className="nav-item">
														<AnchorLink className="nav-link" href="#admin">
															Admin
														</AnchorLink>
													</li>
													<li className="nav-item">
														<AnchorLink className="nav-link" href="#email">
															Email Templates
														</AnchorLink>
													</li>
													<li className="nav-item">
														<AnchorLink className="nav-link" href="#core">
															Core Features
														</AnchorLink>
													</li>
													<li className="nav-item">
				...
				<section
					id="feature"
					className="section-lr section-b-space feature-section"
				>
					<div className="container-fluid">
						<div className="row">
						...
						<div className="row feature_row">
							...
							<div className="col-xl-3 col-md-6 ">
								<div className="feature-box">
									...
									<p className="para">
										Make your web page faster by using lazy loaded. Lazy Load is
										delays loading of images in long web pages. Images outside
							...
							<div className="col-xl-3 col-md-6">
								<div className="feature-box">
									...
									<p className="para">
										Useful feature for Night Owls or people who work during the
										night. The dark background will put less strain on the eyes.
									</p>
								</div>
							</div>
							<div className="col-xl-3 col-md-6">
								...
								<div>
									<div className="row">
										...
										<div className="col-xl-3 col-sm-6 col-12 demo-box">
											...
											<h3>
												pets <span className="badge badge-danger">New</span>
											</h3>
										</div>
										<div className="col-xl-3 col-sm-6 col-12 demo-box">
											<Link
											...
											<h3>
												watch <span className="badge badge-danger">New</span>
											</h3>
										</div>
										<div className="col-xl-3 col-sm-6 col-12 demo-box">
											<Link
											...
											<h3>
												kids <span className="badge badge-danger">New</span>
											</h3>
										</div>
										<div className="col-xl-3 col-sm-6 col-12 demo-box">
											<Link
										...
										<div className="col-xl-3 col-sm-6 col-12 demo-box">
											...
											<h3>
												beauty <span className="badge badge-danger">New</span>
											</h3>
										</div>
										<div className="col-xl-3 col-sm-6 col-12 demo-box">
											<Link
									...
									<div className="row">
										<div className="col-xl-3 col-sm-6 col-12 demo-box">
											...
											>
												...
												/>
												<h3>
													metro <span className="badge badge-danger">New</span>
												</h3>
											</Link>
										</div>
										<div className="col-xl-3 col-sm-6 col-12 demo-box">
